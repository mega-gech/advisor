...
<?php else: ?>
<!-- ======= DASHBOARD LAYOUT ======= -->
<div class="layout <?php echo isset($_SESSION['user_role']) ? htmlspecialchars($_SESSION['user_role']) . '-layout' : ''; ?>">
    <!-- Top Navbar -->
    <nav class="navbar">
    ...
    <!-- Left Sidebar (Student, Advisor & Registrar) -->
    <?php if(isset($_SESSION['user_role']) && in_array($_SESSION['user_role'], ['student', 'advisor', 'registrar'])): 
    ...
    <aside class="sidebar">
            ...
            <div class="brand-text">
                ...
                <span class="brand-subtitle">
                    <?php 
                        ...
                        elseif ($role === 'advisor') echo 'Advisor Portal';
                        else echo 'Registrar Portal';
                    ?>
                </span>
            </div>
        </div>
        ...
        <nav class="sidebar-nav">
            ...
            <?php elseif ($role === 'advisor'): ?>
                <a href="index.php?action=advisor_dashboard" class="nav-item active">
                    <span class="nav-icon"><svg class="icon" width="18" height="18" aria-hidden="true"><use xlink:href="/public/img/icons.svg#home"></use></svg></span>
                    Dashboard
                </a>
                <a href="#" class="nav-item">
                    <span class="nav-icon"><svg class="icon" width="18" height="18"><use xlink:href="/public/img/icons.svg#users"></use></svg></span>
                    My Students
                </a>
                <a href="#" class="nav-item">
                    <span class="nav-icon"><svg class="icon" width="18" height="18"><use xlink:href="/public/img/icons.svg#message"></use></svg></span>
                ...
                <a href="#" class="nav-item">
                    <span class="nav-icon"><svg class="icon" width="18" height="18"><use xlink:href="/public/img/icons.svg#chart"></use></svg></span>
                    Reports
                </a>
                <a href="#" class="nav-item">
                    <span class="nav-icon"><svg class="icon" width="18" height="18"><use xlink:href="/public/img/icons.svg#folder"></use></svg></span>
                ...
                <a href="#" class="nav-item">
                    <span class="nav-icon"><svg class="icon" width="18" height="18"><use xlink:href="/public/img/icons.svg#key"></use></svg></span>
                    Settings
                </a>
                <a href="index.php?action=logout" class="nav-item">
                    <span class="nav-icon"><svg class="icon" width="18" height="18"><use xlink:href="/public/img/icons.svg#logout"></use></svg></span>
            ...
            <?php else: /* registrar */ ?>
                <a href="index.php?action=registrar_dashboard" class="nav-item active">
                    <span class="nav-icon"><svg class="icon" width="18" height="18" aria-hidden="true"><use xlink:href="/public/img/icons.svg#home"></use></svg></span>
                    Dashboard
                </a>
                <a href="#" class="nav-item">
                ...
                <a href="#" class="nav-item">
                    <span class="nav-icon"><svg class="icon" width="18" height="18"><use xlink:href="/public/img/icons.svg#link"></use></svg></span>
                    Assignments
                </a>
                <a href="#" class="nav-item">
                    <span class="nav-icon"><svg class="icon" width="18" height="18"><use xlink:href="/public/img/icons.svg#message"></use></svg></span>
        ...
        <div class="help-card">
            ...
            <?php elseif ($role === 'advisor'): ?>
                <div class="help-card-icon">🎧</div>
                <div class="help-card-title">Need Help?</div>
                <div class="help-card-text">Contact registrar or IT support for any assistance.</div>
                <button class="btn-support">Contact Support</button>
            <?php else: ?>
                <div class="help-card-icon">🖥️</div>
                <div class="help-card-title">Need Help?</div>
                <div class="help-card-text">Contact IT support or system administrator.</div>
                <button class="btn-support">IT Support</button>
            <?php endif; ?>
        </div>
    </aside>
    <?php endif; ?>
